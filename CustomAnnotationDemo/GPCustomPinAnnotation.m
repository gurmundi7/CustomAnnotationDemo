...
@implementation GPCustomPinAnnotation
...
{
    GPSimplePinAnnotation* annotation = (GPSimplePinAnnotation*)anno;
    GPCustomPinAnnotation* customAnno = [[GPCustomPinAnnotation alloc]initWithTitle:annotation.title subTitle:annotation.subtitle cordinate:annotation.coordinate];
    customAnno.tag = annotation.tag;
    return customAnno;
}
-(NSString *)title
{
